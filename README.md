...
| `docs/IT_Infrastructure_Plan_Technical_Documentation_EN.pdf` | Full technical write-up: assumptions, layout, topology, security, phasing |
| `docs/IT_Equipment_Cost_Estimate_EN.pdf` | Itemized equipment cost estimate |
